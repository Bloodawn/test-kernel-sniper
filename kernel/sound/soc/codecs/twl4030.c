...
#include <sound/tlv.h>
#if defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855) // 20100618 junyeop.kim@lge.com, audio path [START_LGE]
...
#elif defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855)
...
#if defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855)
...
//unsigned int dmb_status = 0;	//junyeop.kim@lge.com
#endif // #if defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855)
...
#if defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855) // 20100618 junyeop.kim@lge.com, call path [START_LGE}
...
#if defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855)  /* 20100618 junyeop.kim@lge.com, call path */
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	if(twl4030->is_calling)
		return 0;
#elif defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855)/* 20100913 junyeop.kim@lge.com, fix the headset call path */
		...
		enum snd_soc_bias_level level)
{
...
#elif defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855)
	...
	wm9093_ext_suspend();
#endif
#endif // #elif defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855)
...
#if defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855) /* LGE_CHANGE_S [iggikim@lge.com] 2009-08-06, audio path */
...
#if defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855) || defined(CONFIG_PRODUCT_LGE_HUB) /* LGE_CHANGE_S [iggikim@lge.com] 2009-11-04, call path */
