 ...
 */
static int ls855_marked_instr_event(u64 event)
{
...
static int ls855_get_constraint(u64 event, unsigned long *maskp,
			       unsigned long *valp)
{
...
static int ls855_get_alternatives(u64 event, unsigned int flags, u64 alt[])
{
	alt[0] = event;
...
static int ls855_compute_mmcr(u64 event[], int n_ev,
			     unsigned int hwc[], unsigned long mmcr[])
{
	...
	for (i = 0; i < n_ev; ++i) {
		...
		mmcr1 |= spcsel;
		if (ls855_marked_instr_event(event[i]))
...
static void ls855_disable_pmc(unsigned int pmc, unsigned long mmcr[])
{
	int shift, i;
...
static struct power_pmu ppc970_pmu = {
	...
	.compute_mmcr		= ls855_compute_mmcr,
	.get_constraint		= ls855_get_constraint,
	.get_alternatives	= ls855_get_alternatives,
	.disable_pmc		= ls855_disable_pmc,
