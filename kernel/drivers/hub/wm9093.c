...
#elif defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855)    /*  defined(CONFIG_MACH_LGE_JUSTIN) */
...
{
#if defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900) || defined (CONFIG_PRODUCT_LGE_LS855)	// dajin.kim temp code
	int ret;
	int retry = 3;
