...
#if defined(CONFIG_PRODUCT_LGE_KU5900) ||defined(CONFIG_PRODUCT_LGE_LS855)||defined(CONFIG_PRODUCT_LGE_LU6800)||defined(CONFIG_PRODUCT_LGE_HUB) // 20110105 seungdae.goh@lge.com justin gpio adjust // 20110527 bsnoh@ubiquix.com add Hub Product
...
#if defined(CONFIG_PRODUCT_LGE_KU5900) ||defined(CONFIG_PRODUCT_LGE_LS855)|| defined(CONFIG_PRODUCT_LGE_LU6800)
...
static void headset_det_work(struct work_struct *work)
{
	...
	if(headset_status == 0)
	{
#if defined(CONFIG_PRODUCT_LGE_KU5900) || defined(CONFIG_PRODUCT_LGE_LU6800)||defined(CONFIG_PRODUCT_LGE_LS855)
	#ifdef USE_LDOBIAS	
...
#if defined(CONFIG_PRODUCT_LGE_KU5900)||defined(CONFIG_PRODUCT_LGE_LS855) || defined(CONFIG_PRODUCT_LGE_LU6800)	// 20100814 junyeop.kim@lge.com, dmb ant detect [START_LGE]
	//nothing
#elif defined(CONFIG_PRODUCT_LGE_HUB)
...
//		schedule_delayed_work(&headset_sw_data->delayed_work,	msecs_to_jiffies(type_detection_tim*3));
	...
	if(hook_status == HOOK_RELEASED){
		if(gpio_get_value(headset_sw_data->hook_gpio) == 0){ 	//threshold area for hook key glitch
		    ...
		    hook_status = HOOK_PRESSED; 
//		    input_report_key(headset_sw_data->ip_dev, KEY_HOOK, 1);
#if defined(CONFIG_PRODUCT_LGE_LU6800) || defined(CONFIG_PRODUCT_LGE_KU5900)||defined(CONFIG_PRODUCT_LGE_LS855) //20110404 mikyoung.chang@lge.com B HW Request.roll back the delay time.
...
#if defined(CONFIG_PRODUCT_LGE_KU5900)||defined(CONFIG_PRODUCT_LGE_LS855) || defined(CONFIG_PRODUCT_LGE_HUB)// 20100814 junyeop.kim@lge.com, dmb ant detect [START_LGE]
	//nothing
#else
