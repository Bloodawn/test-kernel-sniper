...
#if defined(CONFIG_PRODUCT_LGE_LS855) || defined(CONFIG_PRODUCT_LGE_KU5900)
...
//	dispc_write_reg(DISPC_IRQENABLE, (mask & 0xFFFFFDFF));		// LGE change kibum.lee@lge.com OCP IRQ disable 
}
...
/* LGE_CHANGE_S [daewung.kim@lge.com] 2012-04-13 */
	...
	dispc_write_reg(DISPC_OVL_TABLE_BA(OMAP_DSS_GFX), virt_to_phys(GammaTable));
